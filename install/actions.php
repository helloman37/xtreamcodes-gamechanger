...
function iptv_write_config_php(string $path, array $vals): void {
  ...
  $php .= "// -----------------------------------------------------------------------------\n\n";
  $php .= "// Payment gateway legacy fallbacks.\n";
  $php .= "// Manage live values from Admin -> Payment Gateways after install.\n";
  $php .= "if (!defined('PAYPAL_CLIENT_ID')) define('PAYPAL_CLIENT_ID', '');\n";
  $php .= "if (!defined('PAYPAL_SECRET')) define('PAYPAL_SECRET', '');\n";
  $php .= "if (!defined('PAYPAL_SANDBOX')) define('PAYPAL_SANDBOX', true);\n";
  $php .= "if (!defined('CASHAPP_CASHTAG')) define('CASHAPP_CASHTAG', '');\n";
  $php .= "if (!defined('STRIPE_PUBLISHABLE_KEY')) define('STRIPE_PUBLISHABLE_KEY', '');\n";
  $php .= "if (!defined('STRIPE_SECRET_KEY')) define('STRIPE_SECRET_KEY', '');\n";
  $php .= "if (!defined('STRIPE_WEBHOOK_SECRET')) define('STRIPE_WEBHOOK_SECRET', '');\n";
  $php .= "if (!defined('STRIPE_MODE')) define('STRIPE_MODE', 'test');\n\n";
  $php .= "\$defaults = {$export};\n\n";
